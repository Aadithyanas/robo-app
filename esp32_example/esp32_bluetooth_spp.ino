/*
 * ESP32 Bluetooth SPP Example for Gemini Bridge
 * 
 * This example code shows how to set up an ESP32 to communicate
 * with the Flutter Gemini Bridge app via Bluetooth SPP.
 * 
 * Requirements:
